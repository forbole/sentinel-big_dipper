...
export default class List extends Component{
    ...
    componentDidUpdate(prevState){
        if (this.props.validators != prevState.validators){
            console.log("Vali..",this.props.validators);
    ...
    render(){
        console.log("Vali.Rende.",this.props.validators);
